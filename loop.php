...
<?php /* How to display posts in the asides category */ ?>
	...
	<?php elseif ( in_category( _x('asides', 'asides category slug', 'twentyten') ) ) : ?>
		...
		<?php if ( is_archive() || is_search() ) : // Display excerpts for archives and search. ?>
			<?php the_excerpt(); ?>
		<?php else : ?>
			<?php the_content( __( 'More', 'twentyten' ) ); ?>
		<?php endif; ?>
...
<?php /* How to display all other posts. */ ?>
	...
	<?php endif; ?>
				...
				<?php edit_post_link( __( '(Edit Post)', 'twentyten' ), '', '' ); ?>
                <p><hr /></p>
...
<?php /* Display navigation to next/previous pages when applicable */ ?>
<?php if (  $wp_query->max_num_pages > 1 ) : ?>
				<p class="bottom-nav left"><?php next_posts_link( __( '« Older posts', 'twentyten' ) ); ?></p>
				<p class="bottom-nav right"><?php previous_posts_link( __( 'Newer posts »', 'twentyten' ) ); ?></p>
<?php endif; ?>